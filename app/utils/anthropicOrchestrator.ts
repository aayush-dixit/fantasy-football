...
function generateFinalRecPrompt(allRecs: string[]) {
  return `Out of all these trade recommendations: ${JSON.stringify(allRecs)}, pick the 3 with the lowest value differences between the user and other team. In the response only return the following JSON object: 
  {
    "userTeam": {
      "sends": [
        {
